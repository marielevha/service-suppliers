              ...
              <div class="featured-category dark">
                <ul>
                  ...
                  <li><a href="search-job.html" data-toggle="tooltip"
                         data-original-title="Banking">Banking</a></li>
                  <li><a href="search-job.html" data-toggle="tooltip" data-original-title="Healthcare">Healthcare</a>
                  </li>
                  <li><a href="search-job.html" data-toggle="tooltip"
                         data-original-title="Software">Software</a></li>
                  <li><a href="search-job.html" data-toggle="tooltip" data-original-title="Automotive">Automotive</a>
                  </li>
                </ul>
              </div>
            </div>
...
import LandingCategories from "@/pages/Landing/LandingCategories";
import LandingJobs from "@/pages/Landing/LandingJobs";
import Default from "@/layouts/default";

export default {
  //layout: 'default',

  components: {Default, LandingJobs, LandingCategories, Footer, TopHeader},
